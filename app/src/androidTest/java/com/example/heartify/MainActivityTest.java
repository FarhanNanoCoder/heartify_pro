...
import com.example.heartify.activities.MainActivity;
...
public class MainActivityTest {
    ...
    public void testAddRecord(){
        ...
        onView(withId(R.id.coe_record_date_edit_text_input)).perform(typeText("22-07-2022"));
    ...
    public void testDetails(){
        ...
        onView(withId(R.id.activity_record_details_sys_pressure)).check(matches(withText("120")));
        onView(withId(R.id.activity_record_details_dia_pressure)).check(matches(withText("80")));
        onView(withId(R.id.activity_record_details_heart_rate)).check(matches(withText("150")));
        onView(withId(R.id.activity_record_details_time_measured)).check(matches(withText("1:5")));
        onView(withId(R.id.activity_record_details_date_measured)).check(matches(withText("22-07-2022")));

        onView(withId(R.id.activity_record_details_back_button)).perform(click());
    ...
    public void testIntentOpen(){
        Intents.init();
        onView(withId(R.id.main_create_button)).perform(click());
        Intents.intended(hasComponent(COERecordActivity.class.getName()));
        onView(withId(R.id.coe_record_systolic_edit_text_input)).perform(typeText("120"));
        onView(withId(R.id.coe_record_diastolic_edit_text_input)).perform(typeText("80"));
        onView(withId(R.id.coe_record_heart_rate_edit_text_input)).perform(typeText("150"));
        onView(withId(R.id.coe_record_time_measured_edit_text_input)).perform(typeText("1:5"));
